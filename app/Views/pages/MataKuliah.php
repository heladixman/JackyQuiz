...
<div class="content-wrapper">
    ...
    <div class="row">
        ...
        <div class="row">
          ...
          <button type="button" class="btn btn-sm btn-primary w-100 h-75" data-bs-toggle="modal" data-bs-target="#ModalNewMataKuliah"><i class="fas fa-plus-circle"></i><?= $addNewButton ?></button>
          </div>
        </div>
      </div>
    </section>
